...
function ResetPasswordContent() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        if (!token) {
            setStatus('error');
            setMessage('Geçersiz bağlantı. Lütfen maildeki linke tekrar tıklayın.');
            return;
        }
        ...
        try {
            ...
            if (res.ok) {
                ...
                setStatus('error');
                setMessage(data.error || 'Şifre sıfırlama başarısız.');
            }
        } catch (error) {
            setStatus('error');
    ...
    if (!token) {
        return (
            <div className="text-center text-red-400">
                ...
                <p className="mt-2 text-gray-400">Linkte token bulunamadı.</p>
                <Link href="/auth/forgot-password" className="mt-4 inline-block text-purple-400 hover:text-white underline">
                    Tekrar link iste
                </Link>
            </div>
        )
        ...
        <>
            ...
            {status === 'success' ? (
                ...
                >
                    ...
                    <h3 className="text-white font-semibold text-lg mb-2">Şifre Güncellendi!</h3>
    ...
    return (
        <div className="min-h-screen bg-black text-white flex items-center justify-center p-4 relative overflow-hidden">
            ...
            <div className="absolute top-0 left-0 w-full h-full overflow-hidden -z-10">
                <div className="absolute top-[10%] left-[50%] -translate-x-1/2 w-[60%] h-[60%] bg-purple-900/10 rounded-full blur-[100px]" />
            </div>
